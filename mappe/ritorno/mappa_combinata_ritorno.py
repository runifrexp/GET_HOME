...
# Stampa per verificare i colori generati
print("Mappa colori autisti:", autisti_color_map)
...
def crea_mappa(csv_file="dati_ritorno.csv", output_file="mappa_combinata_ritorno.html"):
    """
